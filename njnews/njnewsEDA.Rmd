...
cmb_data %>%
  ...
  summarize(oulet_count = as.double(n()),
            weighted_indegree = sum(weighted_indegree, na.rm = T),
            weighted_outdegree = sum(weighted_outdegree, na.rm = T),
            eccentricity = sum(eccentricity, na.rm = T),
            authority = sum(authority, na.rm = T),
            hub = sum(hub, na.rm = T),
            population,
            perc_asian,
            democrats_perc,
